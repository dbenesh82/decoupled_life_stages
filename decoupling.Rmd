...
```{r}
bind_rows(data.frame(dt_out1[1:7]),
...
```{r}
growth <- read.csv(file="data/hs_growth_out.csv", header = TRUE, sep=",")
growth <- select(growth, Parasite.species, Host.no, Stage, maxLCL, abs_diff)
growth
```
