...
That leaves `r length(decoupled$n)` correlations. Of these, `sum(decoupled$p_val < 0.05)` are significant according to our two-sided permutation test, or `r sum(decoupled$p_val < 0.05) / length(decoupled$p_val) * 100` percent.
